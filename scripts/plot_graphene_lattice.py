...
data = pd.read_csv("data/graphene/lattice_scan.csv")
...
plt.title("Graphene: Total Energy vs Lattice Constant")

plt.annotate(
    f"Minimum: a = {equilibrium_lattice:.2f} Å",
    (equilibrium_lattice, minimum_energy),
    xytext=(equilibrium_lattice + 0.015, minimum_energy + 0.03),
...
plt.savefig("figures/graphene_lattice_scan.png", dpi=300)
plt.show()
